...
public class AvatarInputConverter : MonoBehaviour
{
   ...
   // public Transform AvatarHand_Left;
    ...
    void Update()
    {
        ...
        controller.center = Vector3.Lerp(controller.center, XRHead.localPosition + new Vector3(headPositionOffset.x, headPositionOffset.y / 2, headPositionOffset.z), 0.5f);
